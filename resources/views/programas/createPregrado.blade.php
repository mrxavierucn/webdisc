    ...
    <div class="bg-gray-200 shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="border-t border-gray-200">
            <dl>
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    <input class="border rounded border-gray-300 w-96" type="text" name="jefe" value="{{old('jefe')}}">
                        @error('jefe')
                            <br>
                            <small>*{{$message}}</small>
                        @enderror
                ...
                <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border border-gray-200">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <input class="border rounded border-gray-300 w-96" type="text" name="gradoAcademico" value="{{old('gradoAcademico')}}">
                ...
                <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border border-gray-200">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <input class="border rounded border-gray-300 w-96" type="text" name="area" value="{{old('area')}}">
                        @error('area')
                            <br>
                            <small>*{{$message}}</small>
                        @enderror
                ...
                <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border border-gray-200">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <input class="border rounded border-gray-300 w-96" type="text" name="subarea" value="{{old('subarea')}}">
                        @error('subarea')
                            <br>
                            <small>*{{$message}}</small>
                        @enderror
                ...
                <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border border-gray-200">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <input class="border rounded border-gray-300 w-96" type="text" name="acreditacion" value="{{old('acreditacion')}}">
                        @error('acreditacion')
                            <br>
                            <small>*{{$message}}</small>
                        @enderror
                ...
                <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border border-gray-200">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <button class="border rounded border-black hover:bg-cool-gray-300 bg-gray-200 mx-2" type="submit">Añadir Programa de Pre-Grado</button>
                    </dd>
                </div>
            </dl>
        </div>
