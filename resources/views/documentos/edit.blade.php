                ...
                <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border border-gray-200">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <select class="border rounded border-gray-300 w-60" name="tipo">
                            <option {{($documento->tipo)=='reacreditacion' ? 'selected' : '' }} value="reacreditacion">Reacreditacion de Programa</option>
                            <option {{($documento->tipo)=='plan' ? 'selected' : '' }} value="plan">Plan Estrategico</option>
