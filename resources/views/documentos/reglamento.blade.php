...
@section('title','Documentos de reglamento')

@section('content')

<h1 class="text-center font-source">Documentos de Reglamento</h1>
<br>
                        ...
                        @foreach ($reglamentos as $reglamento)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    @auth
                                    <div>
                                        <a href="{{route('documentos.edit',$reglamento)}}" class="text-indigo-600 hover:text-indigo-900">Editar</a>
                                    </div>
                                    <br>
                                    <div>
                                        <form action="{{route('documentos.destroy',$reglamento)}}" METHOD="POST">
                                            @csrf
                                            @method('delete')
