    ...
    <div class="bg-gray-200 shadow overflow-hidden sm:rounded-lg font-source">
        ...
        <div class="border-t border-gray-200">
            <dl>
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    <input class="border rounded border-gray-300 w-96" type="text" name="objetivo" value="{{old('objetivo')}}">
                        @error('objetivo')
                            <br>
                            <small>*{{$message}}</small>
                        @enderror
                ...
                <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border border-gray-200">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <input class="border rounded border-gray-300 w-96" type="text" name="empresa" value="{{old('empresa')}}">
                            @error('empresa')
                                <br>
                                <small>*{{$message}}</small>
                            @enderror
                ...
                <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border border-gray-200">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <button class="border rounded border-black hover:bg-cool-gray-300 bg-gray-200 mx-2" type="submit">Añadir Proyecto</button>
                    </dd>
                </div>
            </dl>
        </div>
